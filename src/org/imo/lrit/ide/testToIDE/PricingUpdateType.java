...
/**
 * 
 * The "Pricing Update" message contains information regarding the
 * pricing schedule for one or more LRIT Data Users.  It may be 
 * generated by either a Data Centre or the IDE.  
 * 
 * A Data Centre sends a "Pricing Update" message to the IDE 
 * containing the pricing information for Data Users associated 
 * with that Data Centre.
 * 
 * "Pricing Update" messages sent by the IDE to Data Centres
 * contain a full set of pricing information for all Data
 * Centres/Users in the LRIT system.
 *             
 * 
...
@XmlType(name = "PricingUpdateType", namespace = "http://gisis.imo.org/XML/LRIT/pricingUpdate/2008", propOrder = {
    "messageType",
    "messageId",
    "message",
    "timeStamp",
