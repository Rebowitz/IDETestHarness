...
/**
 * 
 * The Journal Report is a message sent from a Regional Data Centre (RDC),
 * a Cooperative Data Centre (CDC) or the International Data Centre (IDC)
 * to the International Data Exchange (IDE).  The Journal report
 * contains a record of all of the messages that have passed between
 * member Contracting Governments of the R/C/IDC for a given time
 * period.
 * 
 * The IDE is to add to its Journal records for each of the messages
...
@XmlType(name = "JournalReportType", namespace = "http://gisis.imo.org/XML/LRIT/journalReport/2008", propOrder = {
    "messageType",
    "messageId",
    "message",
    "timeStamp",
