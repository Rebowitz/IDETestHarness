 ...
 * 
 */
@WebServiceClient(name = "ddpService", targetNamespace = "http://gisis.imo.org/XML/LRIT/2008", wsdlLocation = "file:/home/randrews/workspace/lrit_common/etc/DDP.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/home/randrews/workspace/lrit_common/etc/DDP.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/home/randrews/workspace/lrit_common/etc/DDP.wsdl', retrying as a local file");
