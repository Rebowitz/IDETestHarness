 ...
 * 
 */
@WebServiceClient(name = "ideService", targetNamespace = "http://gisis.imo.org/XML/LRIT/2008", wsdlLocation = "http://localhost:8080/ide_dc")
public class IdeService
    extends Service
{

    private final static URL IDESERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(org.imo.gisis.xml.lrit._2008.IdeService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.imo.gisis.xml.lrit._2008.IdeService.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:8080/ide_dc");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/ide_dc', retrying as a local file");
